...
def build_features_for_target_date(
    ...
    for variable in BEHAVIOR_VARIABLES:
        ...
        if variable not in active_variables:
            ...
            features[slope_column] = np.nan
            features[change_column] = np.nan
